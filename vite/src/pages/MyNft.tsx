...
const MyNft: FC = () => {
  ...
  return (
    ...
    >
      ...
      <Button colorScheme={isApprovedForAll? "green":"red"} 
              onClick={onClickSetApprovalForAll}
              isDisabled={isApproveLoading}
              isLoading={isApproveLoading}
              loadingText="로딩중"
              >{isApprovedForAll? "취소":"승인"}</Button>
      ...
      {!isEnd && <Button onClick={() => getNftMetadata()} isDisabled={isLoading} isLoading={isLoading}>더 보기</Button>}
